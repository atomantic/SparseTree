...
import { LinkRelationshipDialog, type RelationshipType } from './LinkRelationshipDialog';
...
export function PersonDetail() {
  ...
  const [relationshipDialogType, setRelationshipDialogType] = useState<RelationshipType | null>(null);
  ...
  return (
    <div className="h-full flex flex-col p-6">
            ...
            <div className="flex flex-wrap items-start gap-2 md:flex-col md:items-start md:gap-2 md:bg-app-bg/30 md:border md:border-app-border/50 md:rounded-lg md:p-2">
              <div className="flex items-center justify-between gap-2 text-xs text-app-text-muted w-16 shrink-0 pt-2 md:w-full md:pt-0 md:pb-1 md:border-b md:border-app-border/40">
                ...
                <button
                  ...
                  onClick={() => setRelationshipDialogType('parent')}
                >
                  + Add
                </button>
              </div>
            ...
            <div className="flex flex-wrap items-start gap-2 md:flex-col md:items-start md:gap-2 md:bg-app-bg/30 md:border md:border-app-border/50 md:rounded-lg md:p-2">
              <div className="flex items-center justify-between gap-2 text-xs text-app-text-muted w-16 shrink-0 pt-2 md:w-full md:pt-0 md:pb-1 md:border-b md:border-app-border/40">
                ...
                <button
                  ...
                  onClick={() => setRelationshipDialogType('spouse')}
                >
                  + Add
                </button>
              </div>
            ...
            <div className="flex flex-wrap items-start gap-2 md:flex-col md:items-start md:gap-2 md:bg-app-bg/30 md:border md:border-app-border/50 md:rounded-lg md:p-2">
              <div className="flex items-center justify-between gap-2 text-xs text-app-text-muted w-16 shrink-0 pt-2 md:w-full md:pt-0 md:pb-1 md:border-b md:border-app-border/40">
                ...
                <button
                  ...
                  onClick={() => setRelationshipDialogType('child')}
                >
                  + Add
                </button>
              </div>
      ...
      <LinkRelationshipDialog
        open={!!relationshipDialogType}
        dbId={dbId!}
        personId={personId!}
        defaultType={relationshipDialogType || undefined}
        onClose={() => setRelationshipDialogType(null)}
        onLinked={async () => {
          // Refresh person data to show new relationships
          const newPerson = await api.getPerson(dbId!, personId!);
          if (newPerson) setPerson(newPerson);
